...
from .views import (
    ...
    get_patch_note_data,
    patch_note_update,
    get_patch_note_data_en,
    patch_note_update_en,
    patch_note_delete,
    patch_note_publish,
    translation_status,
    external_send_now,
...
urlpatterns = [
    ...
    path('data-en/<int:patch_note_id>/', get_patch_note_data_en, name='patch_note_data_en'),
    path('update-en/', patch_note_update_en, name='patch_note_update_en'),

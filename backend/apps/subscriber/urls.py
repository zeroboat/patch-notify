...
from .views import (
    ...
    admin_reactivate_subscription_email,
    issue_token,
    revoke_token,
    subscribe_page,
...
urlpatterns = [
    ...
    path('subscription-emails/<int:customer_id>/reactivate/', admin_reactivate_subscription_email, name='admin_reactivate_subscription_email'),

...
| 역할 | 패치노트 | 고객사/구독 | 공문 발송 | 제품 관리 | Slack 관리 | Django Admin |
|------|----------|------------|----------|----------|-----------|-------------|
...
──────────────────────────────────────────────────
💡 사용 안내
• Slack 알림을 받으려면 봇을 채널에 먼저 초대해야 합니다.
  채널에서 /invite @Patch Notify 입력
• 채널 초대 후 설정 변경에서 채널을 선택하고 저장하세요.
──────────────────────────────────────────────────
[솔루션명]
📧 Gmail: ✅ 3/5개 활성   💬 Slack: ❌ 비활성화
                                      [설정 변경]
[📄 최근 패치노트 보기]
```
